  ...
  return (
    ...
    >
      ...
      <Card>
        ...
        <Text style={{ color: c.muted, marginBottom: 8 }}>
          Exports contain recognized text and photo references in readable JSON.
          Images are not included. Store backups privately.
        </Text>
        <Action
          icon="ios-share"
          label="Export data"
      ...
      <Card>
        ...
        <Text style={{ color: c.muted, marginBottom: 8 }}>
          OCR and duplicate checks run on your device. Clearing the local index
      ...
      <Text style={{ color: c.muted, textAlign: 'center' }}>
        SnapSort {DeviceInfo.getVersion()} · build {DeviceInfo.getBuildNumber()}
      </Text>
    </ScrollView>
  );
}
